...
public class IdiomaLogic {
     ...
     * @throws BusinessLogicException si ya existe un idioma en el sistema con ese mismo id o nombre
     */
     ...
     * @return List<IdiomaEntity> con los idiomas almacenados en la persitencia de la aplicacion
     */
     ...
     * @throws BusinessLogicException  si el idioma identificado con el id del parametro no existe
     */
    public void deleteIdioma(Long idiomaID)throws BusinessLogicException{
        if(this.getIdioma(idiomaID)==null)
            throw new BusinessLogicException("El idioma con id= "+idiomaID+" no existe, por lo tanto no se puede borrar");
