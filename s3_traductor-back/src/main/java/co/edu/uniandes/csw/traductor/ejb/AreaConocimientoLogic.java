...
public class AreaConocimientoLogic {
     ...
     *
     * @param areaEntity La entidad que representa el area de conocimiento a
     * persistir.
     * @return La entidad del area luego de persistirla.
     * @throws BusinessLogicException Si la area de conocimiento a persistir ya
     * existe o si no se cumple la integridad de los datos requeridos.
     */
    ...
    /**
     * Actualiza la areaConocimiento con el id recibido en la URL con la
     ...
     */
    public AreaConocimientoEntity getArea(Long areaId) {
