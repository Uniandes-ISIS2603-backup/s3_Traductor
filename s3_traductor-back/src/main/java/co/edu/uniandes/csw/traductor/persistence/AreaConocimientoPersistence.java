 ...
 * areaConocimiento. De igual modo, esta clase realiza operaciones CRUD para el
...
public class AreaConocimientoPersistence {
     ...
     *
     *
     * @param areaEntity objeto areaConocimiento que se creará en la base de
     * datos
    ...
    /**
     * Busca si hay alguna areaConocimiento con el area que se envía de
     * argumento
     *
     * @param areaBusqueda: Es el nombre del area a quien se le va a realizar la
     * busqueda.
    ...
    /**
     *
     * Borra una areaConocimiento de la base de datos recibiendo como argumento
     * el id de la propuesta
     *
