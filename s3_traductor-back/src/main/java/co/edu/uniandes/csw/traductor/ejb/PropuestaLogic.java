...
public class PropuestaLogic {
     ...
     * @throws BusinessLogicException Si la propuesta a persistir ya existe o si
     ...
     *
     * @param empleadoId Id del empleado a actualizar su propuesta a actualizar
     * en la base de datos.
     * @param propuestaEntity Entidad con la informacion a actualizar en la base
     * de datos.
     ...
     * @throws BusinessLogicException Si la propuesta asociada posee una
