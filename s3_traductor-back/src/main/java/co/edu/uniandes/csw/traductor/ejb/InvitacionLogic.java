...
public class InvitacionLogic {
     ...
     * @param invitacionEntity La entidad que representa la invitacion a
     * persistir.
     * @return La entidad de la invitacion luego de persistirla.
     * @throws BusinessLogicException Si la invitacion a persistir ya existe o
     ...
     *
     * @param invitacionEntity Entidad con la informacion a actualizar en la
     * base de datos.
     * @param clienteId Identificacion del cliente
     ...
     * @throws BusinessLogicException si la invitacion no esta asociada al
     * cliente.
     */
