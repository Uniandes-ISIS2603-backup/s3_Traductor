...
public class DocumentoLogic {
     ...
     *
     * @param documentoEntity entidad que representa un Documento,
     * DocumentoEntity !=null
     * @return El mismo idiomaEntity luego de persistirlo
     * @throws BusinessLogicException si ya existe un documento en el sistema
     * con ese mismo id o nombre
     */
     ...
     *
     * @return List<DocumentoEntity> con los documentos almacenados en la
     * persitencia de la aplicacion
     */
    ...
    public DocumentoEntity getDocumento(Long docID) {
        LOGGER.log(Level.INFO, "Inicia la consulta del documento segun el id={0}", docID);
        ...
        LOGGER.log(Level.INFO, "Termina el proceso de consulta del documento con el id={0}", docID);
        return documentoEntity;
    }
     ...
     */
    public void deleteDocumento(Long docID) {
        LOGGER.log(Level.INFO, "Inicia el borrado del documento segun el id={0}", docID);
