...
/**
 * Clase que implementa la persistencia en la base de datos de la clase propuesta.
...
public class PropuestaPersistence 
{
    ...
    /**
     * Busca las propuestas que existen en la base de datos que posean el costo dado por parametro.     
