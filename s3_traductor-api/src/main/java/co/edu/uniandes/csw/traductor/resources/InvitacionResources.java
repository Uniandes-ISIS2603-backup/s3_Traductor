...
public class InvitacionResources
{
	...
	public List<InvitacionDTO> getAllInvitaciones() {
		...
		//LOGGER.log(Level.INFO, "InvitacionResources getAllInvitaciones: output: {0}", listaPropuestas.toString());
		return null;
	}
	...
	public InvitacionDTO getInvitacion(@PathParam("invitacionId") Long invitacionId) throws WebApplicationException {
		...
		//LOGGER.log(Level.INFO, "InvitacionResources getInvitacion: input: {0}", editorialsId);
		...
		*/
		...
		//LOGGER.log(Level.INFO, "EditorialResources getInvitacion: output: {0}", detailDTO.toString());
		return null;
	}
