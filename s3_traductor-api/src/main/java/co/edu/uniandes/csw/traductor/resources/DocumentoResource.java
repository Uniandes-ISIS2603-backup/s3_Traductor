...
public class DocumentoResource {
    ...
    /**
     * Crea un nuevo Documento con la informacion que se recibe en el cuerpo de
     * la petición y se regresa un objeto identico con un id auto-generado por
     * la base de datos.
     *
     *
     *
     * @param nuevoDocumento {@link DocumentoDTO} - el Documento que se desea
     * guardar.
     ...
     *
     * @return JSONArray {@link DocumentoDTO} - Las Documentos que posee el
     * Documento. Si no hay ninguna retorna una lista vacía.
     */
    @GET
     ...
     *
     * @param documentoId Identificador de la Documento que se esta buscando.
    ...
    public void deleteDocumento(@PathParam("DocumentoId") Long documentoId) throws WebApplicationException {
        ...
        if( documentoLogic.getDocumento(documentoId) == null){
