...
/**
 * Clase que implementa el recurso clientes/{id}/propuestas
 * Permite crear la asociacion entre un cliente existente y una propuesta.
...
public class ClientePropuestaResource
{
    ...
    /**
     * Guarda una propuesta dentro de un cliente con la informacion que recibe el
     * la URL. Se devuelve la propuesta que se guarda en el cliente.
     *
